              ...
              {selected === "Profile" && (
                <div>
                  ...
                  <div className="border-b-2 pb-1.5 px-2 sm:px-4 mt-6 sm:mt-8 flex flex-col sm:flex-row gap-1 sm:gap-0 justify-between items-center text-center sm:text-left">
                    <h1 className="text-[15px] sm:text-[17px] font-bold">Name:</h1>

                    <h1 className="text-base sm:text-xl font-bold">{userName}</h1>
                  </div>
                  <div className="border-b-2 pb-1.5 px-2 sm:px-4 mt-6 sm:mt-8 flex flex-col sm:flex-row gap-1 sm:gap-0 justify-between items-center text-center sm:text-left">
                    <h1 className="text-[15px] sm:text-[17px] font-bold">Bio:</h1>

                    <h1 className="text-base sm:text-xl font-bold">{userBio}</h1>
                  </div>
                  <div className="border-b-2 pb-1.5 mt-6 sm:mt-8 px-2 sm:px-4  flex flex-col sm:flex-row gap-1 sm:gap-0 justify-between items-center text-center sm:text-left">
                    <h1 className="text-[15px] sm:text-[17px] font-bold">Email:</h1>

                    <h1 className="text-base sm:text-xl font-bold">{email}</h1>
                  </div>
                  <div className="border-b-2 pb-1.5 mt-6 sm:mt-8 px-2 sm:px-4  flex flex-col sm:flex-row gap-1 sm:gap-0 justify-between items-center text-center sm:text-left">
                    <h1 className="text-[15px] sm:text-[17px] font-bold">Telephone:</h1>

                    <h1 className="text-base sm:text-xl font-bold">{phoneNo}</h1>
                  </div>
                </div>
              )}
            </div>
